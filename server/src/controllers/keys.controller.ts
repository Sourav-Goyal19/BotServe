...
async function handleGenerateKey(request: FastifyRequest, reply: FastifyReply) {
...
async function handleGetKeys(request: FastifyRequest, reply: FastifyReply) {
  try {
...
async function handleDeleteKey(request: FastifyRequest, reply: FastifyReply) {
  const body = request.body;
...
async function handleUpdateKey(request: FastifyRequest, reply: FastifyReply) {
  const body = request.body;
...
export { handleGenerateKey, handleGetKeys, handleDeleteKey, handleUpdateKey };
